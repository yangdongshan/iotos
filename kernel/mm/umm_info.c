...
void *umm_info( void *ptr) {
  ...
  UMM_FORCE( "+----------+-------+--------+--------+-------+--------+--------+\n" );
  UMM_FORCE("|0x%08lx|B %5i|NB %5i|PB %5i|Z %5i|NF %5i|PF %5i|\n",
  ...
  while( UMM_NBLOCK(blockNo) & UMM_BLOCKNO_MASK ) {
    ...
    if( UMM_NBLOCK(blockNo) & UMM_FREELIST_MASK ) {
      ...
      UMM_FORCE("|0x%08lx|B %5i|NB %5i|PB %5i|Z %5u|NF %5i|PF %5i|\n",
          (unsigned long)(&UMM_BLOCK(blockNo)),
          blockNo,
          UMM_NBLOCK(blockNo) & UMM_BLOCKNO_MASK,
          UMM_PBLOCK(blockNo),
      ...
      UMM_FORCE("|0x%08lx|B %5i|NB %5i|PB %5i|Z %5u|\n",
          (unsigned long)(&UMM_BLOCK(blockNo)),
          blockNo,
          UMM_NBLOCK(blockNo) & UMM_BLOCKNO_MASK,
          UMM_PBLOCK(blockNo),
  ...
  UMM_FORCE("Total Entries %5i    Used Entries %5i    Free Entries %5i\n",
      ummHeapInfo.totalEntries,
      ummHeapInfo.usedEntries,
      ummHeapInfo.freeEntries );

  UMM_FORCE("Total Blocks  %5i    Used Blocks  %5i    Free Blocks  %5i\n",
